...
public class Vibration extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReturnV = (Button)findViewById(R.id.btnReturnV);

        btnReturnV.setOnClickListener(new View.OnClickListener() {
...
//            data.addEntry(new Entry(set.getEntryCount(), (float) (Math.random() * 80) + 10f), 0);
    ...
    protected void onDestroy() {
        mSensorManager.unregisterListener(Vibration.this);
        thread.interrupt();
        super.onDestroy();
    }
}
